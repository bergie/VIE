...
jQuery.toCurie = function (uri, safe, namespaces) {
    var delim = ":";
...
jQuery.isCurie = function (something) {
    return !jQuery.isUri(something) && something.indexOf(":") !== -1;
};

jQuery.toUri = function (curie, namespaces) {
    var delim = ":";
    for (var k in namespaces.toObj()) {
...
jQuery.isUri = function (something) {
    return (typeof something === "string" && something.search(/^<.+:.+>$/) === 0);
};

jQuery.unduplicate = function (arr) {
